...
export default function Chatbot() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Hello! I\'m your Agriculture AI Assistant. I can help you with crop advice, pest management, soil health, and farming practices. What would you like to know?',
      timestamp: new Date()
    }
  ]);
  ...
  const sendMessage = async (messageText?: string) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/api/chatbot/ask', {
        message: textToSend,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Farmer Assistant</h1>
          <p className="text-gray-600">Ask me anything about farming, crops, and agriculture</p>
        </div>
