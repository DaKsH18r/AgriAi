...
const ResetPasswordPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-blue-50 to-emerald-50 flex items-center justify-center p-4">      <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="relative max-w-md w-full">        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">          <div className="text-center mb-8">
        ...
        {!message && token && (
          <form onSubmit={handleSubmit} className="space-y-5">              <div>
      ...
      </div>        <p className="text-center text-xs text-gray-500 mt-6">
